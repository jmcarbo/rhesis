...
This is the transcription for slide 2`
	...
	err = gen.GeneratePresentation(parsedScript, outputFile, "modern", false)
	if err != nil {
...
func TestErrorHandling(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			gen := generator.NewHTMLGenerator()
			err = gen.GeneratePresentation(parsedScript, tt.outputPath, "modern", false)
...
More content`,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := gen.GeneratePresentation(parsedScript, outputFile, "modern", false); err != nil {
